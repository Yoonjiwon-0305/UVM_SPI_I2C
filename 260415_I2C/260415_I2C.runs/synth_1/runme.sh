...
HD_PWD='D:/workplace/UVM_VIM/260415_I2C/260415_I2C.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_i2c_master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo_i2c_master.tcl
