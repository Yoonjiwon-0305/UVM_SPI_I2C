...
HD_PWD='D:/workplace/UVM_VIM/260415_I2C/260415_I2C.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_i2c_master.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demo_i2c_master.tcl -notrace
